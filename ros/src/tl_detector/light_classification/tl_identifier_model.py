...
image_data_gen = datagen.flow_from_directory('/home/student/catkin_ws/src/CarND-Capstone/ros/src/tl_detector/light_classification/images', target_size=(64, 64), classes=['light',  'yellow'],batch_size=batch_size)

model.fit_generator(image_data_gen, epochs=nb_epoch, steps_per_epoch=nb_steps)

model.save('traffic_light_identifier.h5')
